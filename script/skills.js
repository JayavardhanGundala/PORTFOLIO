...
const skills=[
    ...
    { id: "skill-2", name: "HTML", percentage:90,color:"rgb(69, 137, 255),rgb(48, 102, 240)"},
    { id: "skill-3", name: "CSS", percentage:80 ,color:"rgb(112, 179, 255),rgb(68, 127, 252)"},
    { id: "skill-4", name: "React", percentage:70 ,color:"rgb(35, 222, 129),rgb(27, 179, 85)"},
    { id: "skill-5", name: "Next.js", percentage:60 ,color:"rgb(40, 209, 119),rgb(54, 153, 245)"},
    { id: "skill-6", name: "Node.js", percentage:50 ,color:"rgb(91, 101, 115),rgb(55, 65, 79)"},
    ...
    { id: "skill-9", name: "Python", percentage:70 ,color:"rgb(255, 156, 56),rgb(252, 94, 91)"},
    { id: "skill-10", name: "SQL", percentage:80 ,color:"rgb(237, 111, 199),rgb(172, 65, 242)"},
    { id: "skill-11", name: "GraphQL", percentage:50 ,color:"rgb(69, 153, 255),rgb(45, 197, 227)"},
